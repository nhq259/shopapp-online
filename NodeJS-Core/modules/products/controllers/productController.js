...
module.exports.getProducts = async (req, res) => {
  ...
  const andConds = [{ status: "active", deleted: false }];
...
module.exports.getProductsAdmin = async (req, res) => {
  const {
    search = "",
    page = 1,
    category,
...
module.exports.updateProduct = async (req, res) => {
  ...
  const [affectedRows] = await db.Product.update(productData, {
    where: { id },
  });
